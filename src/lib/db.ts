...
function initializeDb(db: Database.Database) {
  ...
  if (templateCount.count === 0) {
    ...
    insertTemplate.run('tpl1', 'Synlab - Casual Intro', 'Quick question about your work',
    ...
    insertTemplate.run('tpl2', 'Synlab - Opportunity', 'Remote receivable role - interested?',
    ...
    insertTemplate.run('tpl3', 'Synlab - Direct', 'Receivable Agent opportunity',
    ...
    insertTemplate.run('tpl4', 'Synlab - Referral style', 'Someone suggested I reach out',
